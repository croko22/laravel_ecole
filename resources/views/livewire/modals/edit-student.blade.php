            ...
            <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                ...
                <form class="mt-5">
                    <div>
                        ...
                        <input placeholder="John" type="text" wire:model="name"
                    ...
                    <div class="mt-4">
                        <label for="lastname" class="block text-sm text-gray-700 capitalize dark:text-gray-200">Student
                            lastname</label>
                        <input placeholder="Doe" type="text" wire:model="lastname"
                            class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                    </div>

                    <p class="text-yellow-500" wire:dirty>You have unsaved changes!</p>
                    <div class="flex justify-end mt-6">
                        <button type="submit" x-on:click="modelOpen = false" wire:click="updateStudent"
